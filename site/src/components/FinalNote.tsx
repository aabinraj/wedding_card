    ...
    <section className="my-12 px-2">
      ...
      >
        ...
        <div className="p-6 md:p-10 text-center relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-4xl font-great-vibes mb-5" style={{ color: "#6B4F5E" }}>
            With Love, S & M
          </h2>
          ...
          <p className="font-outfit text-sm leading-relaxed max-w-xs mx-auto" style={{ color: "#5A3D4A" }}>
