    ...
    <section className="my-10 rounded-3xl overflow-hidden shadow-2xl relative w-full" style={{ aspectRatio: "4/5" }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-start pt-3 px-4">
        ...
        >
          ...
          <h2 className="text-[2.6rem] leading-tight font-great-vibes mb-2 text-[#3A1D2A] drop-shadow-md">
            Wedding Ceremony
          </h2>
          
          <div className="font-outfit space-y-0.5 mb-3 text-[#3A1D2A] max-w-[90%] mx-auto drop-shadow-sm">
          ...
          <div className="inline-block px-3 py-1.5 rounded-full text-[10px] font-outfit font-extrabold tracking-wide shadow-md border border-[#8B6F7E]/40 bg-white/90 backdrop-blur-md text-[#5A3D4A] whitespace-nowrap">
